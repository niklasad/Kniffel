...
public class Pelaaja {
     ...
     * 
     * @param nimi Käytettävän "tuloksen" nimi, eli esimerkiksi ykköset tai täyskäsi
     * @param pisteet Pisteet joita kyseiseen tulokseen toisessa luokassa heitetyillä nopilla saa
     */
     ...
     * @return pisteet jotka tulokselle on merkitty, jos tulosta ei vielä merkitty, palauttaa -1
     */
    ...
    /**
     * Metodi tarkistaa, onko pelaaja oikeutettu hyvitykseen tässä vaiheessa peliä.
     * Jos välisumman pisteet ovat/ylittävät 63, pelaaja saa 50 pisteen hyvityksen.
     * @param nimi kasvattaa välisummaa, jos asetetut pisteet kuuluvat välisummaa kasvattaviin pisteisiin,
     * eli ykkösistä kutosiin.
